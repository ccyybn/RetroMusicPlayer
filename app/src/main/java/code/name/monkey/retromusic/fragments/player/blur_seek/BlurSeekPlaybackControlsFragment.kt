 ...
 *
 */
package code.name.monkey.retromusic.fragments.player.blur_seek
...
import code.name.monkey.retromusic.databinding.FragmentBlurSeekPlayerPlaybackControlsBinding
...
class BlurSeekPlaybackControlsFragment :
    AbsPlayerControlsFragment(R.layout.fragment_blur_seek_player_playback_controls) {
    private var _binding: FragmentBlurSeekPlayerPlaybackControlsBinding? = null
    ...
    override val forwardButton: ImageButton
        get() = binding.forwardButton

    override val backwardButton: ImageButton
        get() = binding.backwardButton
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentBlurSeekPlayerPlaybackControlsBinding.bind(view)
        setUpPlayPauseFab()
