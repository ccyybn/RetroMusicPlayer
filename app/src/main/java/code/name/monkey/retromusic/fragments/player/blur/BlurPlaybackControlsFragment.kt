...
import code.name.monkey.retromusic.databinding.FragmentBlurPlayerButtonControlsBinding
import code.name.monkey.retromusic.fragments.base.AbsPlayerControlsFragment
import code.name.monkey.retromusic.helper.MusicPlayerRemote
import code.name.monkey.retromusic.util.color.MediaNotificationProcessor

class BlurPlaybackControlsFragment :
    AbsPlayerControlsFragment(R.layout.fragment_blur_player_button_controls) {
    private var _binding: FragmentBlurPlayerButtonControlsBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentBlurPlayerButtonControlsBinding.bind(view)
        setUpPlayPauseFab()
    }
